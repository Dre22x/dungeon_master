...
from root_agent.sub_agents import narrative_agent, npc_agent, rules_lawyer_agent, character_creation_agent, campaign_outline_generation_agent
...
root_agent = LlmAgent(
  ...
  tools=[set_state, save_campaign, load_campaign, get_state]
)
